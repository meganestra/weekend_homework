...
#setup and tear down - tidy data - no need for tear down in this one - means don't need to enter hashes in each test method - these are like global variables they can be seen outside of the setup method.  Use the @ sign to change it from a local variable.
  def setup
